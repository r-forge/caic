caic.diagnostics <- function(caicObj, which.terms=NULL, which.plots=c("NV","SD","AGE"), outlier.val=3, label=FALSE, ultrametric.tol=0.0001, ask=FALSE, test.signif=TRUE, plot.signif=TRUE, alpha=0.05, ...){
